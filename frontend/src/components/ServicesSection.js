    ...
    <section className="relative bg-black min-h-screen py-16">
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16 relative">
        ...
        <div className="absolute left-8 lg:left-16 top-8 z-20">
          <h2 className="serif-font text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-light text-white">
            Services
          </h2>
        </div>
        ...
        <div className="pt-32 lg:pt-40">
          {/* Top Row */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8 max-w-[1200px] mx-auto">
            {/* Facial Balancing */}
            <div className="relative group cursor-pointer max-w-[500px] mx-auto lg:mx-0">
            ...
            <div className="relative group cursor-pointer max-w-[500px] mx-auto lg:mx-0 lg:ml-auto">
              <div className="aspect-square overflow-hidden">
                <img 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-[1200px] mx-auto">
            ...
            <div className="aspect-square overflow-hidden relative group cursor-pointer max-w-[350px] mx-auto">
              <img 
            ...
            <div className="flex flex-col justify-center items-center text-center">
              <h2 className="serif-font text-4xl md:text-5xl lg:text-6xl font-light text-white mb-8">
                treatments
              </h2>
              <Link 
                to="/services"
            ...
            {/* Right Image */}
            <div className="aspect-square overflow-hidden max-w-[350px] mx-auto">
              <img 
