...
const Footer: React.FC<FooterProps> = ({ className }) => {
  return (
    <footer className={`bg-gray-900 border-t border-gray-700 py-16 ${className || ''}`}>
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-300 hover:text-white transition-colors" aria-label="Pinterest">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="serif-font text-lg font-medium mb-6 text-white">Quick Links</h3>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            © 2025 Sculpt by U.K. All rights reserved.
          </p>
