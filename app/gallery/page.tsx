                    ...
                    <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {filteredImages.map((image, index) => (
                                <div
                                    key={image.id}
                                    className="group bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer"
                                ...
                                >
                                    ...
                                    {/* Labels below image - always visible */}
                                    <div className="p-4 text-center bg-white">
                                        <h3 className="serif-font text-lg font-medium text-black mb-1">{image.title}</h3>
