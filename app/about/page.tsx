                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                            <div className="slide-in-left">
                                ...
                                <p className="text-gray-600 mb-6 leading-relaxed">
                                    Founded with a vision to redefine aesthetic medicine, Sculpt by U.K represents the pinnacle of non-surgical enhancement. Our journey began with a simple belief: true beauty enhancement should be an art form that celebrates individuality while achieving harmonious results.
                                </p>
                                <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                <section className="py-20 bg-white">
                    <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
                        <div className="text-center mb-16">
                            <h2 className="serif-font text-4xl font-light mb-4 text-black">Our Values</h2>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="text-center fade-in bg-gray-50 p-8 rounded-lg">
                                ...
                                <h3 className="serif-font text-xl font-medium mb-4 text-black">Excellence</h3>
                                <p className="text-gray-600 leading-relaxed">
                            ...
                            <div className="text-center fade-in bg-gray-50 p-8 rounded-lg" style={{ animationDelay: '0.2s' }}>
                                ...
                                <h3 className="serif-font text-xl font-medium mb-4 text-black">Artistry</h3>
                                <p className="text-gray-600 leading-relaxed">
                            ...
                            <div className="text-center fade-in bg-gray-50 p-8 rounded-lg" style={{ animationDelay: '0.4s' }}>
                                ...
                                <h3 className="serif-font text-xl font-medium mb-4 text-black">Trust</h3>
                                <p className="text-gray-600 leading-relaxed">
