    ...
    return (
        <section className="min-h-screen flex items-center justify-center bg-white text-center px-6">
            <div className="w-full max-w-[1400px] mx-auto">
                ...
                <p
                    className="text-lg md:text-xl lg:text-2xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed fade-in"
                    style={{ animationDelay: '0.3s' }}
                >
                    Welcome to Sculpt by U.K, where beauty meets elegance. We specialise in full facial enhancements without the need for surgery. Our team of specialists will guide and advise you on every step of your journey.
                </p>
