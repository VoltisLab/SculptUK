                ...
                <div className="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
                    ...
                    <div className="flex-1 px-4 flex justify-between">
                        ...
                        <div className="ml-4 flex items-center md:ml-6">
                            <Link href="/" className="bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
const SidebarContent: React.FC<{ navigation: any[], pathname: string }> = ({ navigation, pathname }) => {
    return (
            ...
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                <div className="flex items-center flex-shrink-0 px-4">
                    <div className="h-8 w-8 rounded-full border border-white flex items-center justify-center">
                        <span className="text-white font-light">SU</span>
                    </div>
                    <span className="ml-3 text-white text-lg font-light">SculptUK Admin</span>
                </div>
